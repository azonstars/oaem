  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setError(data.error || (language === "bn" ? "লগইন ব্যর্থ হয়েছে। ইউজার আইডি বা পাসওয়ার্ড সঠিক নয়।" : "Login failed. Invalid User ID or Password."));
      }
    } catch {
      ...
      <div className="max-w-md w-full bg-slate-900/90 border border-slate-700/80 rounded-3xl shadow-2xl p-8 backdrop-blur-xl relative overflow-hidden">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          >
            ...
            {loading ? (language === "bn" ? "যাচাই করা হচ্ছে..." : "Authenticating...") : (language === "bn" ? "লগইন করুন" : "Secure Login")}
          </button>
        </form>
      </div>
