...
export function ConferenceNoteTool({ currentUser, systemSettings, offices, financialYears, selectedFY, onBack: _onBack }: ConferenceNoteToolProps) {
            ...
            <div className="p-4 px-6 bg-slate-900 text-white flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="font-bold text-sm">
                  {currentUser?.role === "Super Admin"
                    ? "SQLite সেন্ট্রাল ডাটাবেজে সংরক্ষিত নোট ও আবেদন তালিকা"
                    : "সংরক্ষিত নোট ও আবেদন তালিকা"}
                </h3>
              </div>
              <button
                ...
                <div className="text-center py-12 text-slate-400">
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    {currentUser?.role === "Super Admin"
                      ...
                      : 'সংরক্ষণ বাটনে ক্লিক করে বর্তমান নোটটি সংরক্ষণ করতে পারেন।'}
                  </p>
                </div>
              ) : (
                savedDocs.map((doc) => (
